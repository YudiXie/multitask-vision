...
df_mt = pd.read_csv(os.path.join(EXP_DIR, 'multi_task_tdw_multiscene_0826', 'brainscore_results.csv'), index_col=0)
df_cat = pd.read_csv(os.path.join(EXP_DIR, 'cat_diff_tdw_multiscene_0826', 'brainscore_results.csv'), index_col=0)
