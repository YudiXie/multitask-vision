...
df_mt = pd.read_csv(os.path.join(EXP_DIR, 'multi_task_tdw_1m20240206_resnet50_nopret_0219', 'brainscore_results.csv'), index_col=0)
...
df_pt_rnd_neural.groupby(['exp_group', 'model']).mean()

# %%
# compared with 1110, the difference is 
# (1) change image save folder to 0221_tdw_1m_resnet50
# (2) pret_score read out from df_pt_rnd_neural
...
scatter_errorbar(data_dict,
                 ...
                 folder_name='0221_tdw_1m_resnet50',
